...
$sql = "SELECT courses.id AS course_id, students_table.user_name AS student_name, courses.title AS course_title, teachers.name AS teacher_name, course_times.start_time
